...
\bib{eMAGma}{unpublished}{
   author={Maglione, Joshua}
   author={Wilson, James B.}
   title={The eMAGma Package},
   status={\url{https://github.com/algeboy/eMAGma}},
}
